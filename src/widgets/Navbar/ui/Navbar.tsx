...
export const Navbar = memo((props: NavbarProps) => {
  ...
  if (!isAuth) {
    return (
      <div className={classNames(cls.Navbar, {}, [className])} data-testid='navbar-non-authorization'>
  ...
  return (
    <div className={classNames(cls.Navbar, {}, [className])} data-testid='navbar-authorization'>
      <IconEdit />
      <IconNotification />
      <Avatar src={isAuth.avatar} size={48} />
